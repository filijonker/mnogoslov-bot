...
def start_handler(message):
    ...
    welcome_text = """
    *Привет, я Многослов. Моя задача: помочь тебе написать книгу. Что я умею:
...
- Подкину идею, если наступит ступор
...
def days_handler(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "Понял-принял. А сколько примерно знаков за одну сессию?")
    except ValueError:
...
def chars_handler(message):
    ...
    try:
        ...
        *Отлично, твой план готов!*
        ...
        Я сохранил твою цель. Теперь можешь приступать к работе. Когда напишешь в рукопись сколько-то знаков, возвращайся и запиши прогресс командой `/done [кол-во знаков]` Удачи!.
        """
